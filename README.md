...
* [`src/listapp/`](src/listapp/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/listapp/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `listapp` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/listapp/config.cljs) defaults to `true` in
...
```clj
(ns listapp.example
  (:require [listapp.config :as config])
